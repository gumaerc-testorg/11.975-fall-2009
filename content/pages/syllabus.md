...
Students should read the on-line daily newspaper {{% resource_link "8a134d89-81f8-437a-9e08-c45c5a31f998" "_El Universal_" %}} and come prepared to talk about major events, etc. with particular relevance to Cartagena and the objectives of the Practicum: 

In addition, students should familiarize themselves with the client, {{% resource_link "2e25843d-42e3-440b-a1b5-c8c588de7ade" "la Alcaldía Distrital de Cartagena de Indias" %}}, by closely examining the website and the numerous useful documents and other information contained therein: